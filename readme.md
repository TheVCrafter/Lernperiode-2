...
- [X] Restliche Sounds ins Spiel einfügen
- [X] Verfolgungsmechanismus des Geistes verändern, damit er vollständig funktioniert
- [X] Code mithilfe von Funktionen übersichtlicher gestalten

Zuerst habe ich mich heute mit dem Einbauen weiterer Sounds in das Spiel beschäftigt. Leider fand ich keinen Weg dafür, mithilfe des SoundPlayers mehrere Sounds gleichzeitig abzuspielen. Mit Hilfe von Herr Colic fand ich jedoch heraus, dass es in WinForms eine Möglichkeit dafür geben würde. Ich befürchtete jedoch, dass einige Codeabschnitte in WinForms nicht mehr gleich funktionieren würden, weshalb ich mich vorerst gegen das Ändern des Frameworks entschied. Das Abspielen von 2 Sounds gleichzeitig ist sowieso nicht allzu wichtig, da dies nur die Ess-Sounds des Pac-Mans betreffen würde, auf welche ich im Spiel eigentlich gut verzichten kann. Ich werde mir aber auf nächste Woche trotzdem nochmals ein eventuelles Ändern des Frameworks überlegen. Als ich die meisten Sounds eingebaut hatte, begann ich schliesslich damit, die Struktur meines Codes zu verändern. Ich definierte neu den Grossteil der Variabeln ausserhalb einer Funktion, damit ich von überallher darauf zugreifen konnte. Anschliessend lagerte ich die Verwendete Asii-Art und die Map in Text dateien aus, welche ich mit dem in dem Namespace `System.IO` enthaltenen `File.ReadAllLines();` auslas. Dann erstellte ich schon einmal 3 neue Funktionen namens "PacManTouchesGhost", "GhostDeath" und "PacManDeath", um die Main-Funktion bereits etwas zu kürzen. Damit werde ich nächstes Mal auf jeden Fall fortfahren. Anschliessend setzte ich mich nochmals mit dem Verfolgungsmechanismus auseinander und fand heraus, dass ich 2 Richtungen vertauscht hatte. Nachdem ich diesen Fehler behoben hatte, funktionierte das Ganze zum Glück bereits etwas besser. Anschliessend fand ich heraus, dass sich im echten Pac-Man-Spiel die Tonhöhe der Sirene ab bestimmten Punktzahlen verändert und da ich verschiedene Tonhöhen zur verfügung hatte, beschloss ich dies auch in mein Spiel einzubauen. Dafür erstellte ich also zum Schluss noch ein SoundPlayer-Array mit Sound Files in 5 verschiedenen Tonhöhen, welche ich anschliessend immer in Abständen von jeweils 30 Punkten abrief.
